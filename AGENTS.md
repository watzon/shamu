...
This project is indexed by GitNexus as **shamu** (3791 symbols, 10801 relationships, 295 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/shamu/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/shamu/context` | Codebase overview, check index freshness |
| `gitnexus://repo/shamu/clusters` | All functional areas |
| `gitnexus://repo/shamu/processes` | All execution flows |
| `gitnexus://repo/shamu/process/{name}` | Step-by-step execution trace |
...
Do not rely on session-scoped task trackers for anything that must survive session boundaries. HANDOFF.md is the source of truth for "what's next."
